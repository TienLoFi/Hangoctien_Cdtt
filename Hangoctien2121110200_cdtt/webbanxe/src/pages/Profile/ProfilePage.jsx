...
const ProfilePage = () => {
    ...
    return (
        <div style={{ width: '1270px', margin: '0 auto', height: '500px', color: '#b5192a' }}>
            <ProfileComponent/>
                ...
                <WrapperContentProfile>
                    <WrapperInput>
                        ...
                        {/* <ButtonComponent
                            ...
                            textbutton={'Cập nhật'}
                            styleTextButton={{ color: '#b5192a', fontSize: '15px', fontWeight: '700' }}
                        ></ButtonComponent> */}
                    </WrapperInput>
                    <WrapperInput>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-end', paddingRight: 10 ,gap:'10px'}}>
                    <ButtonComponent
                            onClick={handleUpdate}
                            size={40}
                            styleButton={{
                            ...
                            textbutton={'Cập nhật'}
                            styleTextButton={{ color: 'green', fontSize: '15px', fontWeight: '700' }}
                        ></ButtonComponent>
                            <ButtonComponent
